...
export default function GalleryCard({ work }: { work: IWorkCard }) {
    return (
        ...
        >
            ...
            />
            <h6 className="absolute top-3/4 group-hover:top-0 duration-100 w-full h-full p-1 md:p-2 text-t-sm sm:text-t-md md:text-t-sm-semibold text-gray-200 text-left bg-[#00000095] after:block after:h-1 after:w-14 after:mt-4 after:bg-t-brown">{work.name}</h6>
            <Link
