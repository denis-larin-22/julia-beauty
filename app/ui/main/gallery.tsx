        ...
        <div className="bg-white">
            <section className="lg:container h-fit flex flex-col lg:flex-row">
                <div className="w-full lg:max-w-80 p-5 text-white bg-t-black flex flex-col justify-center text-end">
                    ...
                    <p className="text-t-sm-regular text-t-brown-light">Щоб побачити більше перейдіть до сторінки Мої роботи</p>
                </div>
                <div className="relative p-4 sm:p-10 pb-24 flex flex-wrap gap-6 items-center justify-center">
                    ...
                    <Link href="/gallery" className="absolute bottom-4 mx-auto text-t-black hover:text-white border-2 border-t-brown bg-transparent hover:bg-t-brown py-2 px-5 rounded-xl duration-100">Мої роботи</Link>
                </div>
            </section>
        </div>
    )
