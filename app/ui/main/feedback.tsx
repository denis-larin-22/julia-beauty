...
export default async function Feedback() {
    ...
    return (
        <section className="mb-40 md:mb-72 bg-t-brown-light">
            <div className="max-w-t-maxScreen py-12 mx-auto">
                <div className="container flex flex-col items-center gap-4 text-md">
