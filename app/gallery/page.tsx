                ...
                {portfolioList.map((work, index) => (
                    ...
                    >
                        <Link
                            ...
                            className="relative group h-80 w-72 p-2 flex flex-col justify-between rounded-2xl overflow-hidden shadow-2xl shadow-slate-300"
                        >
                            <img
                                src={work.image}
                                alt="The photo of work from portfolio"
                                className="w-full h-64 rounded-2xl object-cover group-hover:brightness-75 duration-150"
                            />
                            <h6 className="p-2 text-t-sm-semibold border-b-2 border-t-brown-light group-hover:scale-105 duration-150">{work.name}</h6>
                        </Link>
                    </AnimatedWrap>
                ))}
            </section>
